...
const allMenuItems = [
  ...
  { label: "السنوات الدراسية", href: "/dashboard/academic-years", icon: CalendarDays, roles: ["ADMIN"] },
  { label: "الجدول المدرسي", href: "/dashboard/timetable", icon: CalendarDays, roles: ["ADMIN"] },
